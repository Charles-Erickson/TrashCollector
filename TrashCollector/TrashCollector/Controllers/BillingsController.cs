...
namespace TrashCollector.Controllers
{
    public class BillingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BillingId,BillAmount,CustomerId")] Billing billing)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BillingId,BillAmount,CustomerId")] Billing billing)
        {
            if (ModelState.IsValid)
            {
